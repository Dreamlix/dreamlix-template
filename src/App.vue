		...
		<v-main>
			...
			<div style="position:relative;">
				<div style="position: absolute; bottom: 0; left: 0; width: 100%;">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 500"><path fill="#FB9062" fill-opacity="1" d="M0,128L80,133.3C160,139,320,149,480,133.3C640,117,800,75,960,80C1120,85,1280,139,1360,165.3L1440,192L1440,500L1360,500C1280,500,1120,500,960,500C800,500,640,500,480,500C500,500,160,500,80,500L0,500Z"></path></svg>
				</div>
				<v-row>
					<v-col cols="2"> </v-col>
					<v-col cols="8">
			...
			<div style="position: relative; height: 100px; min-height: 50px; background-color: #FB9062">
				<svg style="position:absolute; left: 0; bottom: 0;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 200"><path fill="#454F51" fill-opacity="1" d="M0,128L80,133.3C160,139,320,149,480,133.3C640,117,800,75,960,80C1120,85,1280,139,1360,165.3L1440,192L1440,200L1360,200C1280,200,1120,200,960,200C800,200,640,200,480,200C200,200,160,200,80,200L0,200Z"></path></svg>
			</div>
			<footer-simple logo="header-logo-white.png"></footer-simple>
		</v-main>
	</v-app>
</template>
...
import SectionImageText from '@/core/components/SectionImageText.vue';
...
import FooterSimple from '@/core/templates/footers/FooterSimple.vue';
